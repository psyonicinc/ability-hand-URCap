...
public class ConnectionDaemonProgramNodeView implements SwingProgramNodeView<ConnectionDaemonProgramNodeContribution> {
	...
	public ConnectionDaemonProgramNodeView(Style style) {
		this.style = style;
	}

	@Override
	public void buildUI(JPanel panel, ContributionProvider<ConnectionDaemonProgramNodeContribution> provider) {
