package com.ur.urcap.psyonic.abilityhand.duty.impl;
...
public class AbilityHandDutyNodeContribution implements ProgramNodeContribution {
    ...
    private final AbilityHandDutyNodeView view;
    private final DataModel model;
    private XmlRpcClient xmlRpcClient;
    
    private final UndoRedoManager undoRedoManager;

    public AbilityHandDutyNodeContribution(ProgramAPIProvider apiProvider, AbilityHandDutyNodeView view, DataModel model) {
...
//        return xmlRpcClient != null; // Considered defined if connection is established
    ...
    public void generateScript(ScriptWriter writer) {
        ...
        writer.appendLine(xmlRpcVar + ".set_duty([\"" + getPosition(INDEX_KEY) + "\",\"" + getPosition(MIDDLE_KEY) + "\", \"" + getPosition(RING_KEY) + "\", \"" + getPosition(PINKY_KEY) + "\",\"" + getPosition(THUMB_FLEXOR_KEY) + "\",\"" + getPosition(THUMB_OPPOSITION_KEY) + "\"])");
