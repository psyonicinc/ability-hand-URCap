...
public class XmlRpcMyDaemonInterface {
	...
	public String sendMotorCommands() throws XmlRpcException, UnknownResponseException {
		return processString(XML_RPC_CLIENT.execute("send_motor_commands", new Vector<Object>()));
