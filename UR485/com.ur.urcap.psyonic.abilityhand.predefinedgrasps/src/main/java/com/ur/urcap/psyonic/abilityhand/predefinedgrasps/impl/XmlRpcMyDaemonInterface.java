...
public class XmlRpcMyDaemonInterface {
	private static final int PORT = 49156;
	...
	public String getGrasp(String choice) throws XmlRpcException, UnknownResponseException {
		return processString(XML_RPC_CLIENT.execute("get_grasp", Collections.singletonList(choice)));

	}

	public String sendGrasp() throws XmlRpcException, UnknownResponseException {
		return processString(XML_RPC_CLIENT.execute("send_grasp", new Vector<Object>()));
