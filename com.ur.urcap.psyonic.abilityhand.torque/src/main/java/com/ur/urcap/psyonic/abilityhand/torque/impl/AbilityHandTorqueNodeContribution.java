package com.ur.urcap.psyonic.abilityhand.torque.impl;
...
public class AbilityHandTorqueNodeContribution implements ProgramNodeContribution {
    ...
    private final AbilityHandTorqueNodeView view;
    private final DataModel model;
    private XmlRpcClient xmlRpcClient;
    
    private final UndoRedoManager undoRedoManager;

    public AbilityHandTorqueNodeContribution(ProgramAPIProvider apiProvider, AbilityHandTorqueNodeView view, DataModel model) {
...
//        return xmlRpcClient != null; // Considered defined if connection is established
    ...
    public void generateScript(ScriptWriter writer) {
        ...
        writer.appendLine(xmlRpcVar + ".set_torque([\"" + getPosition(INDEX_KEY) + "\",\"" + getPosition(MIDDLE_KEY) + "\", \"" + getPosition(RING_KEY) + "\", \"" + getPosition(PINKY_KEY) + "\",\"" + getPosition(THUMB_FLEXOR_KEY) + "\",\"" + getPosition(THUMB_OPPOSITION_KEY) + "\"])");
