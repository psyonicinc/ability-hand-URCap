...
public class AbilityHandTorqueNodeView implements SwingProgramNodeView<AbilityHandTorqueNodeContribution> {
    ...
    @Override
    public void buildUI(JPanel panel, ContributionProvider<AbilityHandTorqueNodeContribution> provider) {
    ...
    private Box createSliderBox(String label, final ContributionProvider<AbilityHandTorqueNodeContribution> provider) {
