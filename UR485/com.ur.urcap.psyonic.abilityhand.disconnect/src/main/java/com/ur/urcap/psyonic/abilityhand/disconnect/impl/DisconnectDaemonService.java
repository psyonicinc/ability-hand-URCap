...
public class DisconnectDaemonService implements DaemonService {

	private DaemonContribution daemonContribution;

	public DisconnectDaemonService() {
	}
	...
	public void init(DaemonContribution daemonContribution) {
		...
		try {
			daemonContribution.installResource(new URL("file:com/ur/urcap/psyonic/abilityhand/disconnect/impl/daemon/"));
	...
	public URL getExecutable() {
		try {
			...
			return new URL("file:com/ur/urcap/psyonic/abilityhand/disconnect/impl/daemon/hand-disconnect.py"); // Python executable
