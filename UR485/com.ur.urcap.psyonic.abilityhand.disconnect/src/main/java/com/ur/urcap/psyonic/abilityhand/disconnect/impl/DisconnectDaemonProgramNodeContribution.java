...
public class DisconnectDaemonProgramNodeContribution implements ProgramNodeContribution {

	private final ProgramAPIProvider apiProvider;
	private final DisconnectDaemonProgramNodeView view;
	private final DataModel model;
	private final XmlRpcMyDaemonInterface daemonStatusMonitor;
	private final KeyboardInputFactory keyboardInputFactory;

	public DisconnectDaemonProgramNodeContribution(ProgramAPIProvider apiProvider,
										   DisconnectDaemonProgramNodeView view,
										   DataModel model) {
	...
	private DisconnectDaemonInstallationNodeContribution getInstallation() {
		return apiProvider.getProgramAPI().getInstallationNode(DisconnectDaemonInstallationNodeContribution.class);
	}
}
