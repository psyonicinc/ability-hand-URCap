...
public class PredefinedGraspsDaemonInstallationNodeContribution implements InstallationNodeContribution {
	private static final String XMLRPC_VARIABLE = "grasps_daemon";
	...
	private final PredefinedGraspsDaemonInstallationNodeView view;
	...
	public PredefinedGraspsDaemonInstallationNodeContribution(InstallationAPIProvider apiProvider,
												PredefinedGraspsDaemonInstallationNodeView view,
												DataModel model,
												PredefinedGraspsDaemonService daemonService,
	...
	private void applyDesiredDaemonStatus() {
		new Thread(new Runnable() {
			@Override
			public void run() {
				if (PredefinedGraspsDaemonInstallationNodeContribution.this.isDaemonEnabled()) {
					// Download the daemon settings to the daemon process on initial start for real-time preview purposes
					try {
						PredefinedGraspsDaemonInstallationNodeContribution.this.awaitDaemonRunning();
						// daemonStatusMonitor.setTitle(PredefinedGraspsDaemonInstallationNodeContribution.this.getPopupTitle());
					} catch (Exception e) {
