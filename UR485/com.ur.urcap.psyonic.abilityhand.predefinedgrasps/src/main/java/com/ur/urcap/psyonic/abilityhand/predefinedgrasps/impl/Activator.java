...
public class Activator implements BundleActivator {
	...
	public void start(final BundleContext context) throws Exception {
		PredefinedGraspsDaemonService daemonService = new PredefinedGraspsDaemonService();
		PredefinedGraspsDaemonInstallationNodeService installationNodeService = new PredefinedGraspsDaemonInstallationNodeService(daemonService);
