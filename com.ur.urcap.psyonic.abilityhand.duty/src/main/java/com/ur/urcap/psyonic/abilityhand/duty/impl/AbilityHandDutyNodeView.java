...
public class AbilityHandDutyNodeView implements SwingProgramNodeView<AbilityHandDutyNodeContribution> {
    ...
    @Override
    public void buildUI(JPanel panel, ContributionProvider<AbilityHandDutyNodeContribution> provider) {
    ...
    private Box createSliderBox(String label, final ContributionProvider<AbilityHandDutyNodeContribution> provider) {
