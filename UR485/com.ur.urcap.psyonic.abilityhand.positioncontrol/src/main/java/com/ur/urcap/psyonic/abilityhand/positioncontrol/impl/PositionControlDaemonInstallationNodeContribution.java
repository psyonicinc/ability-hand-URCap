...
public class PositionControlDaemonInstallationNodeContribution implements InstallationNodeContribution {
	...
	private final PositionControlDaemonInstallationNodeView view;
	...
	public PositionControlDaemonInstallationNodeContribution(InstallationAPIProvider apiProvider,
												PositionControlDaemonInstallationNodeView view,
												DataModel model,
												PositionControlDaemonService daemonService,
	...
	private void applyDesiredDaemonStatus() {
		new Thread(new Runnable() {
			@Override
			public void run() {
				if (PositionControlDaemonInstallationNodeContribution.this.isDaemonEnabled()) {
					// Download the daemon settings to the daemon process on initial start for real-time preview purposes
					try {
						PositionControlDaemonInstallationNodeContribution.this.awaitDaemonRunning();
						// daemonStatusMonitor.setTitle(PositionControlDaemonInstallationNodeContribution.this.getPopupTitle());
					} catch (Exception e) {
